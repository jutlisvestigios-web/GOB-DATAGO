...
Write-Host "  Docente:" -ForegroundColor Yellow
Write-Host "    Correo: docente@gobdata360.com" -ForegroundColor Gray
Write-Host "    Contraseña: password123" -ForegroundColor Gray
Write-Host ""
Write-Host "  Estudiante:" -ForegroundColor Yellow
Write-Host "    Correo: estudiante@gobdata360.com" -ForegroundColor Gray
Write-Host "    Contraseña: password123" -ForegroundColor Gray
Write-Host ""
...
if ($respuesta -eq "S" -or $respuesta -eq "s") {
    ...
    Write-Host "  2. Ejecuta: npm start" -ForegroundColor Gray
